...
$config = array (
  ...
  'metadatadir'           => '/var/simplesamlphp/metadata/',
	...
	'technicalcontact_email'    => 'info@ellak.gr',
...
9 => array(
    'class' => 'core:PHP',
    'code' => '
        if (strlen($attributes["eponimo"]<1))
                $attributes["eponimo"] = array("empEponimo");
        if (strlen($attributes["onoma"]<1))
                $attributes["onoma"] = array("tmpOnoma");
        $attributes["email"] = $attributes["username"];
        $attributes["uid1"] = array(
            (string)rand(),
        );
    ',
),
...
onoma	admin
eponimo	admin
foreas	https://idp.asfa.gr/idp/shibboleth
idikotita	
email	admin
...
//        'uid' => 'user'),
		 ...
		 */
 		...
 		//61 => array('class' => 'core:AttributeAdd', 'groups' => array('member')),
...
'metadata.sources' => array(
array('type' => 'flatfile'),
array('type' => 'flatfile', 'directory' => '/var/simplesamlphp/metadata/metarefresh-gr'),
),
*/
